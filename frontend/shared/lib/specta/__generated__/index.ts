...
export const commands = {
	...
	async scanDirectory(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("scan_directory", {
					path,
					recursive,
					showHidden,
				}),
	...
	async searchFiles(query: string): Promise<Result<FileEntry[], string>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("search_files", { query }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async searchContent(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("search_content", { query, path }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async moveEntries(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("move_entries", { paths, targetDir }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getAppIcon(path: string): Promise<Result<string, string>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("get_app_icon", { path }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async renameEntry(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("rename_entry", { path, newName }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async duplicateEntry(path: string): Promise<Result<string, string>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("duplicate_entry", { path }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async moveToTrash(path: string): Promise<Result<null, string>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("move_to_trash", { path }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
